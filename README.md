...
| Падает при удалении записей и наличии SRV-записей | SRV парсится корректно |
...
| `ms_dns_nicru_username` | ✅ | Логин договора (например `123456/NIC-D`) |
...
```
> Обязательно измените данные в пути **MYSERVICE** и **example.com** на свои — название сервиса и домен.
